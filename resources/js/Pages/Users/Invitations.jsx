...
import { Mail, UserPlus, Loader2, RefreshCw, XCircle, ArrowLeft } from "lucide-react";
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center justify-between">
                <div>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-1">
                        <Link to="/users" className="hover:text-foreground inline-flex items-center gap-1">
