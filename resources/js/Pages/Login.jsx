...
export default function Login() {
    ...
    const validate = () => {
        ...
        if (!email) return t("login.validation.identifierRequired");
        if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (remember) {
                ...
                localStorage.setItem("login.email", form.email.trim());
                ...
                <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        >
                            ...
                            <span>{loading ? t("login.submitting") : "Entrar al panel"}</span>
                        </Button>
                    </form>
                </div>
            </div>
